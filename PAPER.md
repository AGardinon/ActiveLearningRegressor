...
2.  Purely explorative experiment setups
    -   May never screen 99%/95% of the target value (overall optimum).
        Up to 90% the behaviour is very herratic (with 10-10 beingh better and 20-5 almost needing the entire 100 pts).
        On average the batch diversity is high or at least comparable with the top diverse exploitation methods.
    -   RMSE/MAE in line with expectations: overall slightly better than exploitative cases.
        Model confidence in general higher tham the exploitative methods.
...
3.  Protocol acquisition experimental setups
    ...
    -   !!! did not try on other batch experiment set up (should I ?)
