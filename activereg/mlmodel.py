...
# - kNN regressor for baseline comparison in AL scenarios (geometric heuristic uncertainty)
...
#         # For uncertainty, we can use the standard deviation of the neighbors' targets
#         distances, indices = self.model.kneighbors(X)
#         y_neighbors = self.model._y[indices]
#         y_std = np.std(y_neighbors, axis=1)
        
#         return y_pred, y_pred, y_std

#     def __repr__(self) -> str:
#         return f"kNNRegressor(n_neighbors={self.n_neighbors})"
